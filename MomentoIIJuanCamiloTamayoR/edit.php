...
<button type="button" class="btn btn-secondary btn-lg btn-block" data-toggle="modal" data-target="#staticBackdrop">
    Instrucciones para modificar la cita
</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Modificar los datos de su cita</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>1. Por favor seleccione el recuadro que requiere modificar.</p>
                <p>2. Una vez se encuentre seleccionado, ingrese la nueva información.</p>
                <p>3. Utilice el botón para modificar la cita.</p>
                <p> Importante. Tenga en cuenta las restricciones: no deben existir campos vacíos, los campos documento y celular son numéricos, el campo celular debe tener 10 dígitos.</p>
            </div>
...
<form class="mt-3" action="update.php?document=<?php echo $row['document'] ?>" method="post" onsubmit="return validate();">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" value="<?php echo $row['name'] ?>" name="name" class="form-control" id="name" data-toggle="tooltip" data-placement="right" title="Actualice el nombre" autofocus>
        </div>
        <div class="form-group col-md-6">
    ...
    <div class="form-group row">
        <div class="col-sm-10">
            <button type="submit" class="btn btn-dark my-2">Modificar cita</button>
        </div>
    </div>
